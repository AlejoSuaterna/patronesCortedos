...
public class WebEbay extends Algorithm {
    ...
    @Override
    public String IngresarLink() {
        return "https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=" + IngreseBusqueda()
    ...
    public String Depurar() {
        Elements cel = getHTML(IngresarLink())
